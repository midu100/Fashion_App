        ...
        <div className="w-full md:w-auto min-w-[320px] md:min-w-[420px]" data-aos="fade-left">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex items-center">
              ...
              <button
                type="submit"
                className="bg-primary hover:bg-primary-light text-dark px-6 py-4 transition-colors duration-300 cursor-pointer flex items-center justify-center active:scale-95 shrink-0"
              >
